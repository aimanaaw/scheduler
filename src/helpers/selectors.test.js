...
//   console.log("AppointmentsEachDay State.Days", state.days);
//   console.log("List of interviewer ids", Object.keys(state.interviewers))
//   // 
//   const dayObject = state.days.find(eachDay => {
//     return "Monday" === eachDay.name;
//   });
//   if (!dayObject) {
//     return [];
//   };
...
//   });
//   console.log("XXXXX", appointmentsArrayOfObjects)
//   const interviewerIdArray = [];
//   appointmentsArrayOfObjects.map( eachAppointment => {
//     console.log("TESTING ------ >", eachAppointment, interviewerIdArray)
//     if (eachAppointment.interview) {
//       interviewerIdArray.push(eachAppointment.interview.interviewer)
//       console.log(interviewerIdArray);
//     }
//   })
//   // 
//   console.log("Interviews for Each Appt State.Appointments", state.appointments)
//   const result = getAppointmentsForDay(state, "Wednesday");
//   expect(result.length).toEqual(0);
// });